...
- **Supabase (перерывы)** — остаётся **тот же общий проект** компании (как на
  старом сайте), он работает на оба сайта параллельно. Отдельно настраивать или
  создавать новый проект **не нужно** — перерывы работают из коробки.
